    ...
    */
      ...
      $("#contactForm").validator().on("submit", function (event) {
          if (event.isDefaultPrevented()) {
            ...
            formError();
            submitMSG(false, "Please Fill Your Form Properly");
          } else {
        ...
        function submitForm(){
          ...
          const url = document.querySelector("#contactForm").getAttribute('url');
          $.ajax({
              type: "GET",
              url: url,
              dataType: "JSON",
              data: { 'f_name': f_name, 'l_name': l_name, 'email': email, 'message': message},
